...
def insert_dummy():
    ...
    reviews_data = [
        ('2023-08-10 14:30', 101, '청담동김밥', '김밥', 5, 1, 'review1.jpg', '정말 맛있어요!'),
        ('2023-08-10 16:45', 101, '청담동김밥', '참치김밥', 4, 1, 'review2.jpg', '참치가 신선하네요!'),
        ('2023-08-10 18:00', 103, '블루커피', '아메리카노', 3, 0, None, '조금 싱거운 편이에요.'),
        ('2023-08-10 19:30', 103, '블루커피', '라떼', 4, 1, 'review4.jpg', '부드럽고 크리미해요.')
    ]
